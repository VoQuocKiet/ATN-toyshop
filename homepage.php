...
<body>
    <main class="">
                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="./image/gundambanner.webp" class="d-block w-100" alt="..." width="ms-auto" height="600px">
                        </div>
                        <div class="carousel-item">
                            <img src="./image/motobanner.jpg" class="d-block w-100" alt="..." width="ms-auto" height="600px">
                        </div>
                    </div>
        ...
        <div class="content">
            ...
            <h1 class="content1 content-line">SUMMARY DELIVERY LAST
        ...
        <nav class="line">
            ...
            <div class="">
                <div class="boxxmas-list">
                    ...
                    $sql = "SELECT *FROM product WHERE categoryID LIKE ('1')";
                    $re = $dblink->query($sql);
                    $row1 = $re->fetch_row();
                    $re->data_seek(0);
                    if ($re->num_rows > 0) :
                    ...
                    ?>
                            <div class="boxxmas col-12 col-md-6 col-sm-4 row">
                                <div class=" boxchildxmas col-12 col-md-8 col-sm-6">
                                    <img class="img-xmas" src="./image/<?= $row['productImage'] ?>">
                                    <a href="detailed.php?id=<?= $row['productID'] ?>" class="text-decoration-none">
