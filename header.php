    ...
    <nav class="navbar navbar-expand-md navbar-white bg-close-white">
        <div class="container-fluid">
            ...
            <a class="navbar-brand col-sm-2 col-form-div">
                <img src="./image/logo.png" alt="" width="75" height="75">ATN STORE
            </a>
            <div class="d-flex">
            ...
            <div class="navbar-nav col-sm-6 col-form-div" id="navbarMain">
                ...
                <div class="navbar-nav ms-auto">
                    ...
                    ?>
                        <a href="showcategory.php" class="nav-link">Manage category</a>
                    ...
                    ?>
                        <a href="#" class="nav-item nav-link" onclick="document.location='login.php'">Login as admin</a>
                    <?php
                    endif;
                    ?>
                </div>
