...
<div class="row">
    ...
    $re->bindParam(":productName", $Name, PDO::PARAM_STR);
    ...
    ?>
        <div class="col-12 col-md-4 pb-3">
            <div class="card-search">
                <div class="img-search"><img src="./image/<?= $r['productImage']?>" class="card-img-top" alt="Product1>"/></div>
                <div class="card-body">
                    ...
                    <h6 class="card-subtitle mb-2 text-muted">$<?= $r['productPrice']?></h6>
                </div>
            </div>
        </div>
    <?php
