...
<body>
    <div class="product-container row">
        <nav class="cate col-12 col-md-6 col-sm-4">
            ...
            <div class="cate-list">
                <a href="?categoryID">All Product</a>
                <?php
                ...
                while ($row = $re->fetch_assoc()) {
                    $href = "?categoryID=$row[categoryID]";
                    echo "<a href='$href'>$row[categoryName]</a>";
                }
                ?>
            </div>
        </nav>
        <nav class="all col-12 col-md-6 col-sm-4">
            ...
            <?php
                ...
                $sql = "SELECT *FROM product WHERE categoryID LIKE ('".$idcat."')";
                $re = $dblink->query($sql);
                $re->data_seek(0);
                if ($re->num_rows > 0) :
                    while ($row = $re->fetch_assoc()) :
